...
@section('content_header')
    <h1 class="text-center text-bold" style="font-family:Arial, Helvetica, sans-serif">DATA PROPOSAL</h1>
@stop
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <div class="btn-group" role="group" aria-label="Basic Example">
                                                        <button type="button" id="btn-edit-dataproposals" class="btn" data-toggle="modal" data-target="#modalEdit" data-id="{{ $key->id }}" data-nama="{{ $key->nama }}" data-npm="{{ $key->npm }}" data-judul_tugas="{{ $key->judul_tugas }}" data-proposal="{{ $key->proposal }}">Terima</button>
                                                        <button type="button" id="btn-delete-dataproposals" class="btn" data-toggle="modal" data-target="#modalDeleteData" data-id="{{ $key->id }}" data-nama="{{$key->nama}}">Revisi</button>
                                                </div>
